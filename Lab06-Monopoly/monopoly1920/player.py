...
class Player:
    ...
    def __init__(self, name, money):
        ...
        #Task 3: add an empty Stack to track mortgaging order
        self.__mortgaging_order = []

    def __str__(self):
        """String representation of the player"""
        return f"{self.__name} - {self.money} - {self.net_worth()}"
    ...
    def mortgage_property(self, deed_name):
        ...
        for p in self.__properties:
            if p.name == deed_name:
                ...
                #task 3: if the mortgage was successful,
                #push the property to the mortgage stack
