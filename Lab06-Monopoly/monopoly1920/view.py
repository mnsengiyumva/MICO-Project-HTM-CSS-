...
class View (observer.Observer):
    ...
    def _create_msg_frame(self):
        ...
        self.state_box.insert(tk.END, "Player 0's Turn")
        ...
        self.text_box.insert(tk.END, "Player 0: Roll the dice!\n")
    ...
    def _action_taken(self, action):
        ...
        #Task 3: 3-1: Add an action for when "unmortgage" is clicked (trigger the "unmortgage" Event
